...
EXPERIMENT_BASE_TESTING_REGIMES = [(20,10)]
...
EXPERIMENT_SIZE_GENERALIZATION_REGIMES = [(2*x, x) for x in np.arange(10, 40, 4)]
# EXPERIMENT_SIZE_GENERALIZATION_REGIMES = [(2*x, x) for x in np.arange(40, 200, 8)] # TODO CAUTION 8
